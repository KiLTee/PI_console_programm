...
"""!@file main.pннннsss
@brief Модуль запуска программxrrrrrrfsdfsdfxxxxxxы — анализатор информации об уязвимостях.
@author [Имя автора]
...
def change_dict(table_inf: any, bdu: any, key: any) -> None:
    ...
    включая наименоваыыыыыыыыыsние, идентификатор, описание, класс, ПО, версию и другие атрибуты.
